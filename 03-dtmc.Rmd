...
$S = \{0,1,2\}$ as given in
ExampleÂ [ExampleÂ 2](#NCD){reference-type="ref" reference="NCD"}, suppose
...
1.  Denote $\boldsymbol{\mu}  = (\mu_1, \mu_2, \mu_3) =  (0.5,0.3,0.2)$
    ...
    ExampleÂ [ExampleÂ 5](#MKProperty1){reference-type="ref"
...
::: {.example}
*In ExampleÂ [ExampleÂ 9](#weather){reference-type="ref"
...
2.  The simple random walk as given in Example
    [ExampleÂ 12](#simpleRW){reference-type="ref" reference="simpleRW"}
...
1.  *Develop an Excel worksheet or create an R code to simulate 50 steps
    ...
    ExampleÂ [ExampleÂ 12](#simpleRW){reference-type="ref"
...
(a) *NCD system (Example [ExampleÂ 2](#NCD){reference-type="ref"
    reference="NCD"}),*

(b) *the health insurance system (Example
    [ExampleÂ 3](#healthInsurance){reference-type="ref"
    reference="healthInsurance"}), and*

(c) *a simple random walk (Example
    [ExampleÂ 12](#simpleRW){reference-type="ref"
    reference="simpleRW"}),*
...
::: {.example}
*Consider the Markov chain defined in Example
[ExampleÂ 17](#exampleMC){reference-type="ref" reference="exampleMC"}.
...
defined in Example [ExampleÂ 18](#eg_absorption){reference-type="ref"
...
*Recall from
ExampleÂ [ExampleÂ 9](#weather){reference-type="ref" reference="weather"},
...
::: {.example}
*For the NCD process in Example
[ExampleÂ 2](#NCD){reference-type="ref" reference="NCD"}, the Markov
...
ExampleÂ [ExampleÂ 25](#rwInfiniteS){reference-type="ref"
...
[ExampleÂ 30](#exampleLongTerm){reference-type="ref"
