...
2.  Suppose that the value of a commodity as a random walk, where each
    ...
    **Solution:** We have $S_{100}$ is a sum of $S_0$ and the i.i.d
    random variables $Z_i$ (each not need to be normal distribution), i.e. 
    $$ S_{100} = S_0 + \sum_{i=1}^{100} Z_i. $$ Moreover,
...
$\mathrm{E}[X_5] = 95 \cdot \left( 1 p^0 (1-p)^5 \right) + 97 \cdot \left(5 p^1 (1-p)^4 \right) + 99 \cdot \left(10 p^2 (1-p)^3 \right) + \cdots + 105 \cdot \left( 1 p^5 (1-p)^0 \right) = 95 + 10*x.$
...
$E\left[Z_{i}\right] = p-q  = p - (1 - p) = 2p -1.$
