...
\(S = \{0,1,2\}\) as given in
ExampleÂ~\protect\hyperlink{NCD}{ExampleÂ~2}, suppose
...
\item
  ...
  ExampleÂ~\protect\hyperlink{MKProperty1}{ExampleÂ~5} that,
...
\emph{For the NCD system given in
ExampleÂ~\protect\hyperlink{NCD}{ExampleÂ~2}, suppose
...
\emph{In ExampleÂ~\protect\hyperlink{weather}{ExampleÂ~9}, on Sunday, the chances of rain, cloudy and sunny
...
\item
  ...
  \protect\hyperlink{simpleRW}{ExampleÂ~12}
...
\item
  ...
  ExampleÂ~\protect\hyperlink{simpleRW}{ExampleÂ~12}. Repeat the simulation 10 times. How many of
...
\item
  \emph{NCD system (Example \protect\hyperlink{NCD}{ExampleÂ~2}),}
\item
  \emph{the health insurance system (Example
  \protect\hyperlink{healthInsurance}{ExampleÂ~3}), and}
\item
...
\emph{Consider the Markov chain defined in Example
\protect\hyperlink{exampleMC}{ExampleÂ~17}.
...
defined in Example \protect\hyperlink{eg_absorption}{ExampleÂ~18} on the set \(\{0, 1, 2\}\) with the transition
...
\emph{Recall from
ExampleÂ~\protect\hyperlink{weather}{ExampleÂ~9},
...
\emph{For the NCD process in Example
\protect\hyperlink{NCD}{ExampleÂ~2}, the Markov
...
ExampleÂ~\protect\hyperlink{NCD}{ExampleÂ~2}
aperiodic?}
...
ExampleÂ~\protect\hyperlink{simpleRW}{ExampleÂ~12}, determine the period of each state.}
...
ExampleÂ~\protect\hyperlink{rwInfiniteS}{ExampleÂ~25}, determine the period of each state.}
...
\protect\hyperlink{exampleLongTerm}{ExampleÂ~30}}
...
\item
  ...
  ExampleÂ~\protect\hyperlink{exampleStationary}{ExampleÂ~22}, if follows that
