...
{\centering \includegraphics{SCMA469Bookdownproj_files/figure-latex/tikz-ex0-1} 

}

\caption{The 3-state model of terminal illness}\label{fig:tikz-ex0}
\end{figure}
...
{\centering \includegraphics{SCMA469Bookdownproj_files/figure-latex/tikz-ex1-1} 

}

\caption{A model of the mortality of two lives}\label{fig:tikz-ex1}
\end{figure}
...
{\centering \includegraphics{SCMA469Bookdownproj_files/figure-latex/tikz-ex2-1} 

}

\caption{A Markov model for health insurance policies}\label{fig:tikz-ex2}
\end{figure}
